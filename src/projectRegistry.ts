...
export function handleProjectRegistered(event: ProjectRegisteredEvent): void {
  ...
  project.primarySalesReceiver = _traitsContract.primarySalesReceiver();
  project.secondarySalesReceiver = _artworkContract.royaltyInfo(BigInt.fromString("0"), BigInt.fromString("1000")).getValue0();
